...
def play(
    ...
    **kwargs,
    ...
    frames = []
    framesdir = os.path.join(savedir, "frames.pkl")
    framesdir = os.path.abspath(framesdir)
    with open(framesdir, "wb") as f:
    ...
    while True:
        ...
        if glyphs is not None:
            frames.append((glyphs, action, reward, obs["glyphs"], done))
